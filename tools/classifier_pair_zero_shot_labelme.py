...
DEFAULT_STATE_PROMPTS: Dict[str, List[str]] = {
    "healthy_green_vegetation": [
        "healthy green vegetation on a hillside",
        "green trees and bushes",
        "normal dense vegetation",
    ],
    "seasonal_leaf_color": [
        "intact tree crowns with normal yellow red or brown seasonal foliage",
        "a hillside covered by standing trees whose leaves changed color seasonally",
        "autumn-colored woodland with dense continuous tree crowns",
        "seasonal leaf color change without bare branches cut trees or disturbed soil",
    ],
    "dry_or_leafless_vegetation": [
        "standing trees with dry sparse leaves and many visible bare branches",
        "dry or leafless vegetation with upright trunks still in place",
        "a hillside with dead foliage substantial leaf loss or exposed branches",
        "withered standing trees without logging debris fallen trunks or disturbed soil",
    ],
    "cut_or_fallen_trees": [
        "cut trees and logging debris on a hillside",
        "fallen tree trunks and broken vegetation",
        "uprooted or collapsed trees on a slope",
    ],
    "cleared_or_excavated_slope": [
        "a deliberately excavated engineered slope with a smooth regular cut face",
        "a manmade road-cut slope with straight edges regular benches or terraces",
        "a cleared hillside with machine tracks construction access or excavation marks",
        "a geometrically shaped bare slope beside a road",
        "engineered excavation rather than an irregular natural collapse",
    ],
    "natural_landslide": [
        "an irregular natural slope collapse with a visible head scarp and displaced earth",
        "a chaotic unengineered slope failure with broken soil rock and debris",
        "a natural landslide with a downslope movement path and material accumulated at the slope toe",
        "an uneven collapsed hillside with torn vegetation and disturbed ground",
        "irregular natural failure rather than a smooth engineered road cut",
    ],
    "exposed_rock_or_soil": [
        "a stable continuous exposed bedrock or bare soil surface",
        "an intact rocky hillside without collapse displaced debris or a movement path",
        "long-standing bare earth with no head scarp and no material accumulated downslope",
        "continuous in-place rock or soil rather than detached loose stones",
        "a naturally exposed surface that is not collapsed and not mechanically excavated",
    ],
    "loose_rock_or_gravel": [
        "loose detached rocks and gravel scattered on a slope",
        "separate stones and angular rock fragments lying on the ground",
        "loose gravel accumulated beside a mountain road",
        "detached rocks lying on a road or roadside shoulder",
        "a cluster of loose rock debris at the edge of a mountain road",
        "isolated stones below a roadside cliff",
        "broken rock fragments accumulated at the toe of a steep road cut",
        "discrete loose stones rather than a continuous exposed bedrock surface",
    ],
    "vehicle": [
        "a car or truck on a road",
        "a vehicle in a road scene",
        "traffic on a mountain road",
        "a passenger car viewed from above",
        "an aerial view of a sedan inside the selected region",
    ],
    ...
    "road_surface": [
        "a close-up image dominated by a paved or unpaved road surface",
        "the main subject is asphalt pavement",
        "a road surface filling most of the selected region",
    ],
    "person": [
    ...
    "manmade_structure": [
        "a guardrail wall building sign or utility pole",
        "an ordinary manmade roadside structure",
        "roadside infrastructure rather than slope damage",
    ],
}

DEFAULT_TRANSITION_PROMPTS: Dict[str, List[str]] = {
    "construction_clearing": [
        "left before and right after: dense vegetation was replaced by a smooth geometrically shaped engineered cut slope",
        "left before and right after: a vegetated hillside became a regular bare road-cut slope with benches or excavation marks",
        "left before and right after: construction clearing and mechanical hillside excavation occurred without chaotic natural collapse",
    ],
    "vegetation_loss_candidate": [
        "before and after images: dense vegetation changed into cut fallen or removed trees",
        "a green tree canopy before and severe vegetation loss after",
        "trees were felled or cleared between the before image and the after image",
    ],
    "landslide_candidate": [
        "left before and right after: an intact natural hillside developed an irregular collapse with displaced soil and debris",
        "left before and right after: a new head scarp downslope movement path and chaotic landslide deposit appeared",
        "left before and right after: natural slope material moved downward and accumulated at the slope toe without regular excavation geometry",
    ],
    "rockfall_candidate": [
        "before and after images: new fallen rocks appeared on the road or roadside",
        "a clear road before and fresh rockfall debris after",
        "new loose stones from a roadside cliff in the after image",
    ],
    "seasonal_leaf_color_change": [
        "before and after images: intact green tree leaves changed to intact yellow red or brown seasonal foliage",
        "normal seasonal leaf color change without tree removal or disturbed soil",
    ],
    "leaf_drying_or_fall": [
    ...
    "non_target_change": [
        "before and after images show a vehicle person road or ordinary manmade object change",
        "an unrelated roadside object changed without slope damage",
    ],
    "no_meaningful_change": [
        "before and after images show the same land cover with no meaningful physical change",
        "no important change between the before image and the after image",
    ],
    "other_visual_change": [
        "before and after images show another visual change that is not a landslide rockfall or vegetation loss",
        "an unclassified visual difference between two views",
    ],
}
